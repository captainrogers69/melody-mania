...
class MelodySliverAppbar extends StatefulWidget implements PreferredSizeWidget {
  final List<Widget>? actions;
  final Widget? leading;
  final String title;
  const MelodySliverAppbar({
    required this.title,
    this.actions,
    this.leading,
    super.key,
  ...
  @override
  State<MelodySliverAppbar> createState() => _MelodySliverAppbarState();

  @override
  Size get preferredSize => const Size.fromHeight(kToolbarHeight);
}

class _MelodySliverAppbarState extends State<MelodySliverAppbar> {
  ScrollNotificationObserverState? _scrollNotificationObserver;
  bool _scrolledUnder = false;
